...
This is a reference guide to the procedures and systems used by the Philippine Airspace and the Manila Area Control Center (ACC). As per the quest to improve all of the lesson-based materials within our vACC, we proudly inform everyone that this repository will be open-source and, thus, editing of files for the mere reason of development is very much encouraged.
...
### Editing
If you find anything that is missing or that is incorrect, or you simply want to contribute; 
1. Create a fork
2. In the `docs` folder, you can make and edit pages. 
